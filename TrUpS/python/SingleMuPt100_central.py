...
# with command line options: Configuration/Generator/python/SingleMuPt100_cfi.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:7E33v4 --conditions auto:startup_7E33v4 --datatier GEN-SIM-RAW --eventcontent RAWSIM -n 10 --no_exec
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SingleMuPt100.root'),
