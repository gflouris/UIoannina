...
// Fri Mar 29 11:41:23 2013 by ROOT version 5.32/00
// from TTree GENTree/GENTree
// found on file: ./L1TreeDTTF.root
//////////////////////////////////////////////////////////
...
#ifdef GENClass_cxx
GENClass::GENClass(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
//    if (tree == 0) {
//       TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/mnt/storage/shared/L1TreeDTTF.root");
//       if (!f || !f->IsOpen()) {
//          f = new TFile("/mnt/storage/shared/L1TreeDTTF.root");
//       }
//       TDirectory * dir = (TDirectory*)f->Get("/mnt/storage/shared/L1TreeDTTF.root:/GENTProducer");
...
Int_t GENClass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t GENClass::LoadTree(Long64_t entry)
{
...
void GENClass::Show(Long64_t entry)
{
...
Int_t GENClass::Cut(Long64_t entry)
{
