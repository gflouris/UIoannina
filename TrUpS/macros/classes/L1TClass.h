...
// Thu Mar 28 16:16:59 2013 by ROOT version 5.28/00h
...
//          f->cd("/mnt/storage/shared/L1TreeDTTF.root:/l1NtupleProducer");
//       }
...
Int_t L1TClass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t L1TClass::LoadTree(Long64_t entry)
{
...
void L1TClass::Show(Long64_t entry)
{
...
Int_t L1TClass::Cut(Long64_t entry)
{
