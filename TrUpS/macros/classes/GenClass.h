...
// Thu Jul 16 16:20:55 2015 by ROOT version 6.02/05
...
#ifdef GenClass_cxx
GenClass::GenClass(TTree *tree1) : fChain(0) 
{
...
//       }
//       TDirectory * dir = (TDirectory*)f->Get("../test/Tree_from_RAW_200events_locally_cmssw_LUTS_lin.root:/GENTProducer");
...
void GenClass::Init(TTree *tree1)
{
